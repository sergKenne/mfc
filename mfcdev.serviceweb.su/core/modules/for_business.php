<?php 
    class for_business extends baseModule{
        ...
        */
        ...
        public static function view($object = false, $callFromPage = false){
            if(is_numeric($object)){ $object = for_business::getById($object);}
            if($object instanceof for_business){
                if(!$callFromPage){
